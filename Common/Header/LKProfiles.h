...
char szRegistryMaxAutoZoomThreshold[]= "MaxAutoZoomThreshold1";
char szRegistryMinAutoZoomThreshold[]= "MinAutoZoomThreshold1";
...
extern const char szRegistryMaxAutoZoomThreshold[];
extern const char szRegistryMinAutoZoomThreshold[];
